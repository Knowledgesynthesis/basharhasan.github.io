...
data = {
    ...
    'Predicted 3-Year Probability of Recmet (%)': [
        6.9, 7.6, 8.4, 9.4, 10.4,
        11.4, 12.6, 13.9, 15.3, 16.9,
        18.5, 20.3, 22.1, 24.1, 26.3,
        28.5, 30.9, 33.3, 35.9, 38.5,
        41.2, 44.0, 46.7, 49.6, 52.4,
        55.2, 57.9, 60.7, 63.3, 65.9,
        68.4, 70.8, 73.0, 75.2, 77.2,
        79.2, 81.0, 82.6, 84.2, 85.6,
        87.0, 88.2, 89.3, 90.3, 91.3,
        92.1, 92.9, 93.6, 94.3, 94.8,
        95.4, 95.8, 96.3, 96.7, 97.0,
        97.3, 97.6, 97.8, 98.1, 98.3,
        98.5, 98.6, 98.8, 98.9, 99.0,
        99.1, 99.2, 99.3, 99.4
    ]
}
